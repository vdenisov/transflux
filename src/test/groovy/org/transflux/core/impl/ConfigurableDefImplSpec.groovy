...
class ConfigurableDefImplSpec extends Specification {
    ...
    def 'post-configurer #mutator on #desc throws naming the def'() {
        ...
        'step'                | 'forException'       | { new StepDefImpl<Object, Object>('op1') }    | { it.forException(RuntimeException) }     | "step 'op1'"
        ...
        'conditional operation'    | 'forException'       | { new ConditionalOperationDefImpl<Object, Object>('c1') }     | { it.forException(RuntimeException) }     | "conditional operation 'c1'"
