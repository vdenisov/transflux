 ...
 */
public class StateDefImpl<T, C> implements StateDef<T, C> {
     ...
     */
    public StateDefImpl(StateMachineDefImpl<T, C> smd, String id) {
     ...
     */
    public StateDefImpl(StateMachineDefImpl<T, C> smd, Identifiable identifiable) {
        requireNotNull(smd, "State machine definition");
